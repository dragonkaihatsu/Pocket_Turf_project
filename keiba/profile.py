...
どちらの数字を使うかを1か所で決める。
    ...
    data/profiles/nar/   地方（大井など）— **2026-09-19に削除した**。
                         枠組みは残してあるので、また集めれば使える
...
NAR = "nar"
JRA = "jra"
# 既定は中央。**地方のデータを削除した（2026-09-19・本人の指示）ので、
# 既定を地方に残すと「実測ファイルが無いので静かに中立へ倒れる」状態に
# なる。** プロファイル取り違えの事故が繰り返し起きたのも、既定が地方で
# 単体スクリプトが --profile を受けなかったことが原因だった
DEFAULT_PROFILE = JRA
